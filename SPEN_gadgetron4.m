...
function [Parameters] = reconstruct_image(input,connection,Parameters)
...
%     acq_header.SPEN_parameters.nShots = acq_header.SPEN_parameters.Nseg;
    ...
    acq_header.FinalA = Parameters.FinalA;
            ...
            if acq_header.SPEN_parameters.nShots==1
                [SPEN_Image]=function_OneShotReconstruction(CmplxData,acq_header.SPEN_parameters.gccmtx_aligned_finalx,acq_header.SPEN_parameters.nccx,acq_header.FinalAFull,acq_header.SPEN_parameters);
