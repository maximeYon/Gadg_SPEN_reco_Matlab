		...
		<xsl:choose>
	   	 ...
	   	 <userParameters>
                        <userParameterLong>
                          <name>rvalue</name>
                          <value>
                            <xsl:value-of select="siemens/MEAS/sWipMemBlock/alFree[1]" />
                          </value>
 			 </userParameterLong>
...
<!--                         <userParameterLong>
                        ...
                        <userParameterLong>
                          <name>b_value_scheme</name>
                          <value>            
                            <xsl:value-of select="siemens/MEAS/sDiffusion/dsScheme"/>
                          </value>
 			 </userParameterLong> -->
